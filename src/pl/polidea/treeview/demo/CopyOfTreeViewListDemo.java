 ...
 * 
 */
public class CopyOfTreeViewListDemo extends Activity {
/*    private enum TreeType implements Serializable {
    ...
    private static final String TAG = CopyOfTreeViewListDemo.class.getSimpleName();
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        simpleAdapter = new TreeViewAdapter(this, selected, manager,
                LEVEL_NUMBER);
